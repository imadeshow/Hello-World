 ...
 */
  ...
  @Produces(MediaType.APPLICATION_JSON)
    ...
    /**
     * Creates a new member from the values provided. Performs validation, and will return a 
     * JAX-RS response with either 200 ok,
  ...
  @Produces(MediaType.APPLICATION_JSON)
     ...
     * If the error is standard
     * bean validation errors then it will throw a ConstraintValidationException with the set of 
     * the constraints violated.
     * </p>
     * <p>
     * If the error is caused because an existing member with the same email is registered 
     * it throws a regular validation
  ...
  private void validateMember(Member member)
     ...
     * and their message. This can then be used
