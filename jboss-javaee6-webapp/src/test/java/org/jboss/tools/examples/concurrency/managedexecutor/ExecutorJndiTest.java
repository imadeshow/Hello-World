...
public class ExecutorJndiTest {
  ...
  */
  ...
  /** some.
  * @throws NamingException xxx
  */
  @Before
  public void setup() throws NamingException {
    InitialContext ctx = new InitialContext();
    defaultExecutor = (ManagedExecutorService) ctx
      .lookup("java:comp/DefaultManagedExecutorService");

    //executorFromWebXml = (ManagedExecutorService) ctx
    //.lookup("java:comp/env/concurrent/myExecutor");
